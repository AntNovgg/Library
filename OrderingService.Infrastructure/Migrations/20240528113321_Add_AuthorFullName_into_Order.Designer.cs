...
namespace OrderingService.Infrastructure.Migrations
{
    ...
    [Migration("20240528113321_Add_AuthorFullName_into_Order")]
    partial class Add_AuthorFullName_into_Order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderingService.Domain.Aggregates.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("OrderingService.Domain.Aggregates.RenterAggregate.FullName", "AuthorFullName", b1 =>
                        {
