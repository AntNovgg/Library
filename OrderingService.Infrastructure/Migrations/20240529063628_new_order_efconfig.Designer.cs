...
namespace OrderingService.Infrastructure.Migrations
{
    ...
    [Migration("20240529063628_new_order_efconfig")]
    partial class new_order_efconfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderingService.Domain.Aggregates.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("OrderingService.Domain.Aggregates.RenterAggregate.AuthorFullName", "AuthorFullName", b1 =>
                        {
